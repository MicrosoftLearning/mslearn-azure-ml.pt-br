---
lab:
  title: Executar ajuste de hiperparâmetro com um trabalho de varredura
---

# Executar ajuste de hiperparâmetro com um trabalho de varredura

Hiperparâmetros são variáveis que afetam como um modelo é treinado, mas que não podem ser derivadas dos dados de treinamento. Escolher valores ideais de hiperparâmetros para o treinamento do modelo pode ser difícil e geralmente envolve muitas tentativas e erros.

Neste exercício, você usará o Azure Machine Learning para ajustar hiperparâmetros executando várias avaliações de treinamento em paralelo.
...
## Ajuste hiperparâmetros com um trabalho de varredura

Agora que você tem todos os recursos necessários, pode executar o notebook para enviar um trabalho de varredura.

1. Abra o notebook **Labs/09/Hyperparameter tuning.ipynb**.
