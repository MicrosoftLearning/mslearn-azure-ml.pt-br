---
lab:
  title: Crie e explore o painel da IA Responsável
---

# Crie e explore o painel da IA Responsável

Depois de treinar seu modelo, convém avaliá-lo para explorar se ele está funcionando conforme o esperado. Além das métricas de desempenho, há outros fatores que você pode levar em consideração. O painel de IA responsável no Azure Machine Learning permite que você analise os dados e as previsões do modelo para identificar qualquer viés ou injustiça.

Neste exercício, você preparará seus dados e criará um painel de IA responsável no Azure Machine Learning.
...
## Crie um pipeline para avaliar modelos e enviar de um notebook

Agora que você tem todos os recursos necessários, você pode executar o notebook para recuperar os componentes de IA responsáveis integrados, criar um pipeline e enviar o pipeline para gerar um painel de IA responsável.

1. Abra o notebook **Labs/10/Create Responsible AI dashboard.ipynb**.
