---
lab:
  title: Implantar um modelo em um ponto de extremidade em lote
---

# Implantar um modelo em um ponto de extremidade em lote

Em muitos cenários, a inferência é realizada como um processo em lote que usa um modelo preditivo para pontuar um grande número de casos. Para implementar essa variante de solução de inferência no Azure Machine Learning, você pode criar um ponto de extremidade em lote.

Neste exercício, você implantará um modelo do MLflow em um ponto de extremidade em lote e o testará em dados de exemplo enviando um trabalho.
...
1. Abra o notebook **Labs/11/Deploy to batch endpoint.ipynb**.
